...
namespace BankManagementDotnetApi.Controllers
{
    ...
    public class MoneyTransfersController : ControllerBase
    {
        ...
        public MoneyTransfersController(BankApiDbContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<MoneyTransfer>> GetMoneyTransfer(int? id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutMoneyTransfer(int? id, MoneyTransfer moneyTransfer)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteMoneyTransfer(int? id)
        {
            var moneyTransfer = await _context.MoneyTransfers.FindAsync(id);
            if (moneyTransfer == null)
            {
