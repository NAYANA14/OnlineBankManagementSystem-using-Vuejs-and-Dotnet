...
namespace BankManagementDotnetApi.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bank = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AccountNumber = table.Column<int>(type: "int", nullable: false),
                    BranchCity = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegisteredPayees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RegisteredPayees_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Amount = table.Column<int>(type: "int", nullable: false),
                    SenderAccountNumber = table.Column<int>(type: "int", nullable: true),
                    RegisteredPayeeId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoneyTransfers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MoneyTransfers_RegisteredPayees_RegisteredPayeeId",
                        column: x => x.RegisteredPayeeId,
                        principalTable: "RegisteredPayees",
                        principalColumn: "Id");
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoneyTransfers_RegisteredPayeeId",
                table: "MoneyTransfers",
                column: "RegisteredPayeeId");

            migrationBuilder.CreateIndex(
                name: "IX_RegisteredPayees_CustomerId",
                table: "RegisteredPayees",
                column: "CustomerId");
